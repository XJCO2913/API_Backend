...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.CommentID = field.NewString(tableName, "commentId")
	_comment.AuthorID = field.NewString(tableName, "authorId")
	_comment.MomentID = field.NewString(tableName, "momentId")
	_comment.Content = field.NewString(tableName, "content")
	_comment.CreatedAt = field.NewTime(tableName, "createdAt")
	_comment.UpdatedAt = field.NewTime(tableName, "updatedAt")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.CommentID = field.NewString(table, "commentId")
	c.AuthorID = field.NewString(table, "authorId")
	c.MomentID = field.NewString(table, "momentId")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["commentId"] = c.CommentID
	c.fieldMap["authorId"] = c.AuthorID
	c.fieldMap["momentId"] = c.MomentID
