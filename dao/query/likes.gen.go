...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.UserID = field.NewString(tableName, "userId")
	_like.MomentID = field.NewString(tableName, "momentId")
	_like.CreatedAt = field.NewTime(tableName, "createdAt")
	_like.UpdatedAt = field.NewTime(tableName, "updatedAt")
...
func (l *like) updateTableName(table string) *like {
	...
	l.UserID = field.NewString(table, "userId")
	l.MomentID = field.NewString(table, "momentId")
...
func (l *like) fillFieldMap() {
	...
	l.fieldMap["momentId"] = l.MomentID
