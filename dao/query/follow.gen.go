...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.UserID = field.NewString(tableName, "userId")
	_follow.FollowingID = field.NewString(tableName, "followingId")
	_follow.CreatedAt = field.NewTime(tableName, "createdAt")
	_follow.UpdatedAt = field.NewTime(tableName, "updatedAt")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.UserID = field.NewString(table, "userId")
	f.FollowingID = field.NewString(table, "followingId")
...
func (f *follow) fillFieldMap() {
	...
	f.fieldMap["followingId"] = f.FollowingID
